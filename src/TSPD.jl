...
function solve_tspd(x, y, speed_truck, speed_drone; n_groups=1, method="TSP-ep-all", time_limit=MAX_TIME_LIMIT)
    ...
    return divide_conquer(x, y, speed_truck, speed_drone; local_search_methods=local_search_methods, method=method, n_groups=n_groups, time_limit=time_limit)
end
