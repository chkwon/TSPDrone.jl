...
function divide_conquer(x, y, speed_truck, speed_drone, flying_range; n_groups=1, method="TSP-ep-all", local_search_methods=[two_point_move, one_point_move, two_opt_move], time_limit=MAX_TIME_LIMIT)
    ...
    for i in 1:n_groups
        ...
        tspd_len, t_route_idx, d_route_idx = tsp_ep_all(Ct_, Cd_, init_tour, flying_range; local_search_methods=local_search_methods, time_limit=time_limit_each_group)   
