...
function solve_tspd(
    ...
    return divide_partition_search(x, y, truck_cost_factor, drone_cost_factor; local_search_methods=local_search_methods, method=method, n_groups=n_groups, flying_range=flying_range, time_limit=time_limit)
end
